...
public class HashTableConcept {
    ...
    public static void main(String[] args) {
        ...
        //It is thread safe so it's sequential threading as one thread can get access at a time so performance is slower
        //If we want to improve performance then we don't use HashTable, rather use HashMap
        //HashTable -- is an implementation of HashTable, it stores on the basis of keys on the HashCode of an object.
        ...
        //HashCode is Java Object Number, whenever we create an object, Java provides particular HashCode for that specific object, so Java object is..
        ...
        h2.put(1, 100);
        h1.put("A", 200); //Now PutMethod will not work because we restricted it with 2 integer
        ...
        //h6 is a replica of h1 by cloning
        h6 = (Hashtable) h1.clone(); //Have to type cast into HashTable, now h6 will the 4 values from h1

        System.out.println("The values from h1: " + h1);
        System.out.println("The values from h2: " + h6); //Here the values of h1 is given to h2

       h1.clear();
        System.out.println("The values from h1: " + h1);  //This cleared all the values from h1
        System.out.println("The values from h2: " + h6);
       ...
       //How to print all the values from HashTable using -- using Enumeration elements() method?
        ...
        st1.put("B", "Jewell");
        st1.put("C", "Selenium");
        st1.put("C", "Selenium"); //It contains only unique values, so when printed Selenium will not print twice
        ...
        //System.out.println(st1); also works, leaving above blank & put (st1) inside here
        // Will NOT print Selenium 2 times even tough it is written twice above because it only contains Unique elements so called only once


        System.out.println(st1);

        //How to check both HashTables are equal or NOT?
        if (st.equals(st1)) //s = st.1
        ...
        System.out.println(st1.get("B")); //Use GetMethod and pass the key
