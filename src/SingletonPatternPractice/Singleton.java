...
//
//    Important for Framework & Interview.    |     **IQ: What you mean by Singleton pattern or Singleton class in Java and how can you achieve the same concept in Selenium?
//    or implement the concept in Selenium?          Ans: In OOP, a singleton class is a special class that can have ONLY ONE OBJECT or INSTANCE of the class AT A TIME. Same thing..
//    Singleton is a PATTERN, it is NOT a KEYWORD   |     we can achieve in Selenium as well. If the driver = NULL then create the object otherwise don't create it.
//
//
//    How to design Singleton class?     **IQ: What do you mean by Lazy Initialization?
//    1st: Make constructor of the class as PRIVATE
//    2nd: Write a PUBLIC static (getInstance) Method, that has a return type of object of this SINGLETON class. (AKA Lazy Initialization)
//   |
    ...
    public static void main(String[] args) {  //Now to test it write PSVM, Inside we'll test this feature
        ...
        x.str = (x.str).toUpperCase(); //Will return str = string & convert to capital with UpperCase() method then STORE it inside x.str on the other side of = to instantiate it
