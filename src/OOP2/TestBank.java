...
public class TestBank {
    ...
    public static void main(String[] args) {
        ...
        ICICIBank ic = new ICICIBank();  //Can you create object of child class? : Yes
        ...
        //USBank.min_balance = 200;  //Interface variable is "Final & Static" by nature, so it's set in ICICIBank = 100, therefore it cannot be assigned nor Changed like this
