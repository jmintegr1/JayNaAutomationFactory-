...
public class LocalVsGlobalVariables {
    ...
    public static void main(String[] args) {
        ...
        //So to access GLOBAL variable that are NON-STATIC then we have to create an object of their class which is LovalVsGlobalVariables, so instantiate this class...
