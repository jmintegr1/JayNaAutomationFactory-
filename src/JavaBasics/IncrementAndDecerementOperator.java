...
public class IncrementAndDecerementOperator {
    ...
    public static void main(String[] args) {
        ...
        int i = 1;
        int j = i++;  //Post increment -- Give the value I to J as is, since it is 1 so j does not go up. Then by increment it increases the value of i by 1 so now i = 2
        ...
        int a = 1;     ////Pre increment: Increase the value of A by 1 first
        ...
        int n = m--;  //then decrease it by 1.. Post decrement, when the decrement is after the letter
        System.out.println(m);
        System.out.println(n);

        int p = 2; //Pre decrement 1 = Since we first decrease the value of P by 1 from 2
