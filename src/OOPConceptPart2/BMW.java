...
public class BMW extends Car { //Keyword "extends" creates THE relationship (child inherits).
    // *IQ: What is this relationship called?    Ans: This is called HAS-A relationship, it's CLASS to CLASS relationship by using keyword Extends
    // Only if we are calling by Dynamic (Runtime) Polymorphism then overridden method & parent class method will be called.
    ...
    during COMPILE TIME is called Method Overriding*/
